...
export const contactFormSchema = z.object({
  fullName: z
    .string()
    .min(3, "Required at least 3 characters long")
    .max(30, "Required no more than 30 characters long")
    .regex(nameRegex, "Invalid field"),
  email: z
    .string()
    .min(3, "Required to enter an email")
    .max(80, "Required no more than 80 characters long")
    .regex(emailRegex, "Invalid field"),
  subject: z.string().min(1, "Required to select a subject"),
  description: z
    .string()
    .max(500, "Required no more than 500 characters long")
