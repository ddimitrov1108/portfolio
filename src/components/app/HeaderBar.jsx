...
export default function HeaderBar() {
  ...
  return (
    <>
      <div
        className={clsx(
          "z-40 cursor-pointer fixed bottom-8 right-8 transition-all p-2.5 text-2xl rounded-full bg-gradient-to-tr from-primary-dark via-primary-main to-cyan-400 text-white",
